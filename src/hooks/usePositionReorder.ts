...
import { UpdateProps } from "./useMeasurePosition";

export function usePositionReorder(initialState: Array<any>) {
  ...
  const updatePosition = (i:number, offset:UpdateProps) => (positions[i] = offset);
